...
function marketToInfo(market: Market): PerpMarketInfo {
 ...
 */
export async function fetchBluefinMarkets(client: BluefinClient): Promise<PerpMarketInfo[]> {
...
export function seedSyntheticCoinMetadata(
  markets: readonly PerpMarketInfo[],
 ...
 */
export function resolveMarketSymbol(markets: readonly PerpMarketInfo[], rawSymbol: string): string {
